<script setup>
import { orderGetCheckInfoAPI, orderCreateOrderAPI } from '@/apis/order.js'
import { ref } from 'vue'
...
const activeAderess = ref({})
const switchAddress = (item) => {
  activeAderess.value = item
}
const changeAddress = () => {
  curAddress.value = activeAderess.value
  ...
  <el-dialog v-model="showDialog" title="切换收货地址" width="30%" center>
    <div class="addressWrapper">
      <div
        ...
        :class="{ active: item.id === activeAderess.id }"
      >
        <ul>
          <li>
